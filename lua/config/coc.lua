...
local function register_mappings(mappings, default_options)
    for mode, mode_mappings in pairs(mappings) do
        for _, mapping in pairs(mode_mappings) do
            local options = #mapping == 3 and table.remove(mapping) or
                                default_options
...
g.coc_global_extensions = {
    'coc-css', 'coc-cssmodules', 'coc-diagnostic', 'coc-dictionary',
    'coc-docker', 'coc-eslint', 'coc-git', 'coc-go', 'coc-gocode',
    'coc-highlight', 'coc-json', 'coc-lua', 'coc-prettier', 'coc-project',
    'coc-rls', 'coc-sh', 'coc-snippets', 'coc-sql', 'coc-tsserver',
    'coc-tslint-plugin', 'coc-vimlsp', 'coc-webpack', 'coc-yaml', 'coc-yank',
    'coc-lists', 'coc-rust-analyzer'
}
...
vim.cmd([[
    ...
    "Add `:Lint` command to lint & fix current buffer
